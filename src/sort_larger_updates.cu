...
__global__ void findSuccessor2( unsigned char *dArrayStringVals, unsigned long long int *dArraySegmentKeys,  
...
__global__ void  eliminateSingleton2(unsigned int *dArrayOutputvalIndex, unsigned int *dArrayValIndex, unsigned int *dArrayStaticIndex, 
...
__global__ void rearrangeSegMCU2(unsigned long long int *dArraySegmentKeys, unsigned long long int *dArraySegmentKeysOut, 
...
void printChars2(unsigned long long int val, unsigned int segmentBytes) { 
...
void initBuckets2(unsigned char* inbuf, int keyLen, int numKeys, thrust::host_vector<unsigned char> hStringVals, thrust::host_vector<unsigned int> hValIndex, thrust::host_vector<unsigned long long int> hKeys) {
...
void GpuUpdates::sortLargerUpdates(uint64_t* gIndices) {
...
#pragma omp parallel for num_threads(NTHREADS)
    ...
    while(true) { 
        ...
        debug.print("************ Calling findSuccessor2 kernel");
        findSuccessor2<<<grid, threads, 0>>>(dArrayStringVals, dArraySegmentKeys, dArrayValIndex, 
        ...
        thrust::transform(dSegmentKeysOut.begin(), dSegmentKeysOut.begin() + numKeys, dTempVector.begin(), getSegmentBytes2());
        ...
        synchronizeDevice(); 
        eliminateSingleton2<<<grid, threads, 0>>>(dArrayOutputvalIndex, dArrayValIndex, dArrayStaticIndex, 
        ...
        synchronizeDevice();
        rearrangeSegMCU2<<<grid1, threads1, 0>>>(dArraySegmentKeys, dArraySegmentKeysOut, dArraySegment, 
